...
<!-- Iterative workflow for diagnosing and fixing SCL compile errors.
     Maximum 5 iterations before escalating. -->

## Frontmatter
- **Tags**: debug, compile, error, fix, scl, loop, iterate
...
- **`ErrorCount == 0`**: Loop complete. Proceed to the calling workflow (e.g. `new-project-from-scratch.md` Step 7).
