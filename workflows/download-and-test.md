...
<!-- Validate a compiled program, download it to a PLC or PLCSim instance,
     then verify operation by reading and writing live variables via S7.Net. -->

## Frontmatter
- **Tags**: download, test, s7, verify, validate, runtime, read, write
...
- Compile errors → follow **[debug-compile-errors.md](debug-compile-errors.md)**
- Hardware not configured → run **[new-project-from-scratch.md](new-project-from-scratch.md)** Step 3–4

---

### Step 2: Download the software

> ⚠️ **Confirm with the user before this step.** Downloading overwrites the PLC program and will interrupt any running process.
...
> ⚠️ **Confirm with the user before writing to a live PLC.** Writing can affect running machinery and processes.
