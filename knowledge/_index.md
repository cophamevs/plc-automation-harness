...
> Core reference documents for SCL programming and Siemens S7 PLCs.
...
- `industry/` — Domain-specific application examples → see `industry/_index.md`
- `libraries/` — Third-party function block libraries → see `libraries/_index.md`
